...
class Map1(Map):
    ...
    def setup(self, main):
        ...
        self.add_entity(Wall(12, 224, 10, 12, main))
        self.add_entity(Wall(12, 236, 16, 23, main))
        self.add_entity(Wall(378, 224, 10, 12, main))
        self.add_entity(Wall(372, 236, 16, 23, main))
