...
class Map7(Map):
    ...
    def setup(self, main):
        # --- Base structure ---
        self.add_entity(Wall(0, 730, 1000, 50, main))      # Ground floor
        self.add_entity(Wall(490, 200, 20, 730, main))     # Center Wall

        # --- Spikes (Loop) ---
        for x in range(0, 1000, 20):
            self.add_entity(Spike(x, 711, main))

        # --- Left side - Player 1 Platforms ---
        self.add_entity(Wall(100, 685, 100, 20, main))
        self.add_entity(Wall(250, 620, 100, 20, main))
        self.add_entity(Wall(400, 555, 100, 20, main))
        self.add_entity(Wall(250, 500, 100, 20, main))
        self.add_entity(Wall(100, 445, 100, 20, main))
        self.add_entity(Wall(20, 390, 20, 20, main))
        self.add_entity(Wall(100, 325, 100, 20, main))
        self.add_entity(Wall(250, 260, 100, 20, main))
        self.add_entity(Wall(400, 195, 100, 20, main))

        # --- Right side - Player 2 Platforms ---
        self.add_entity(Wall(800, 685, 100, 20, main))  
        self.add_entity(Wall(650, 620, 100, 20, main))  
        self.add_entity(Wall(500, 555, 100, 20, main))  
        self.add_entity(Wall(650, 500, 100, 20, main))  
        self.add_entity(Wall(800, 445, 100, 20, main))  
        self.add_entity(Wall(960, 390, 20, 20, main))    
        self.add_entity(Wall(800, 325, 100, 20, main))
        self.add_entity(Wall(650, 260, 100, 20, main))
        self.add_entity(Wall(500, 195, 100, 20, main))
        # --- INTERACTIVE WALLS (Moving Elements) ---
        # FIX: Texture veranderd naar 'wall/platform' (die bestaat waarschijnlijk wel)
